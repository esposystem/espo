	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:200px;padding:10px 30px;" title="<?php echo $config->get('appName')?>" buttons="#dlg-buttons">
		...
		<form id="ff" method="post">
			<table>
				<tr>
					<td>Usuario:</td>
					<td><input type="text" class="lowercase" name="login" style="width:250px;" required="true"></td>
				</tr>
				<tr>
					<td>Clave:</td>
					<td><input type="password"  class="lowercase"  name="clave" style="width:250px;"required="true"></td>
				</tr>
