...
class si_cf_parametroModel
{
	...
	const FIELD_IDPARAMETRO = 10132372;
	const FIELD_VALOR = 40195862;
	const FIELD_DESCRIPCION = 20375133;
	const FIELD_ESTADO = 95481888;
	const FIELD_FECHATRCR = 20393340;
	const FIELD_USUARIOTRCR = 62720755;
	const FIELD_FECHATRED = 19862183;
	const FIELD_USUARIOTRED = 13729464;
      
    public function __construct()
    {
        $this->db = new APPDbo();
        $this->entityName = "SI_CF_PARAMETRO";
	...
	$arrayParam  = array();
		...
		//fetchAll( $table , $column_names = array('t.*'),$join = array(),$condition = '' ,$sortBy = '',$inOrder = '', $type = "array",$groupBy = '' )
    ...
    public function saveRow($id){
        ...
        $this->db->UPDATE($this->entityName,$fields,array( $this->getPrimaryKey() =>$id),TRUE);
