...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"Este campo es obligatorio.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"Ingrese un email valido."},url:{validator:function(_443){
...
},message:"Ingrese una URL valida."},length:{validator:function(_444,_445){
