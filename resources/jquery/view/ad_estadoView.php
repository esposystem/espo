	...
	<script type="text/javascript">
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/ad_estado/update/'+row.IDADESTADO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/ad_estado/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="IDAUDIENCIA" width="50" sortable="true">IDAUDIENCIA</th>
				<th field="IDESTADO" width="50" sortable="true">IDESTADO</th>
				<th field="FECHA" width="50" sortable="true">FECHA</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:238px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>IDAUDIENCIA</label>
				<input name="IDAUDIENCIA" class="easyui-numberbox" required="true">
			</div>
			<div class="fitem">
				<label>IDESTADO</label>
				<input name="IDESTADO" class="easyui-numberbox" required="true">
			</div>
			<div class="fitem">
				<label>FECHA</label>
				<input name="FECHA" class="easyui-datetimebox" readonly >
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
