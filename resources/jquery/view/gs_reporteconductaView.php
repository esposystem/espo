...
//alert(fields[i]);
					...
					rowStrCard += '<p><div class="columna">Número de Interno  :</div><div class="columnValor">' + rowData["NUMEROINTERNO"] + '</div><div class="columna">Identificación  :</div><div class="columnValor">' + rowData["NUMDOCUMENTO"] + '</div></p>'; //+ ' ' + rowData["APELLIDO2CONDENADO"] + ' ' +  rowData["NOMBRECONDENADO"] + '</div></p>';
				...
				options:{
					...
					onChange:function(value){
					    ...
					    options:{
						    panelHeight:'auto',
						    data:[{value:'',text:'Todos'},{value:'Buena',  text:'Buena' },{value:'Ejemplar',  text:'Ejemplar' },{value:'Regular',  text:'Regular' },{value:'Mala',  text:'Mala' }],
						    onChange:function(value){
							    if (value == ''){
		...
		function newRecord(){
			url = '/app/gs_reporteconducta/create';
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_reporteconducta/update/'+row.IDREPORTE;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:820px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_reporteconducta/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="IDESTABLECIMIENTO" width="50" sortable="true">Establecimiento</th>
				<th field="NUMDOCUMENTO" width="50" sortable="true">Identificacion</th>
				<th field="NUMEROINTERNO" width="50" sortable="true">Numero de Interno</th>
				<th field="FECHAACTA" width="50" sortable="true">Fecha de Acta</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:524px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Fecha de Reuni&oacute;n Consejo</label>
				<input name="FECHACONSEJO" class="easyui-datebox textbox"  >
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				...
				<input type="radio" id="CALIFICACION" class="easyui-validatebox" name="CALIFICACION" value="Buena" >Buena<input type="radio" id="CALIFICACION" class="easyui-validatebox" name="CALIFICACION" value="Ejemplar" >Ejemplar<input type="radio" id="CALIFICACION" class="easyui-validatebox" name="CALIFICACION" value="Regular" >Regular<input type="radio" id="CALIFICACION" class="easyui-validatebox" name="CALIFICACION" value="Mala" >Mala
			</div>
			<div class="fitem">
