...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/pr_dm_diafestivo/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pr_dm_diafestivo/update/'+row.IDDIA;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pr_dm_diafestivo/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="FECHA" width="10" sortable="true">FECHA</th>
				<th field="DESCRIPCION" width="50" sortable="true">Nombre</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:212px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Nombre</label>
				<input name="DESCRIPCION" class="easyui-validatebox" validType="text" size="40" required="true">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
