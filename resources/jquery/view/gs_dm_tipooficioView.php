...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/gs_dm_tipooficio/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_dm_tipooficio/update/'+row.IDTIPOOFICIO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_dm_tipooficio/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="CODIGO" width="50" sortable="true">CODIGO</th>
				<th field="NOMBRE" width="50" sortable="true">Tipo de Oficio</th>
				<th field="VENCE" width="50" sortable="true">Vence</th>
				<th field="VENCIMIENTO" width="50" sortable="true">Dias de Vencimento</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:264px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Vence</label>
				<input name="VENCE" class="easyui-validatebox" >
			</div>
			<div class="fitem">
				<label>Dias de Vencimento</label>
				<input name="VENCIMIENTO" class="easyui-numberbox" >
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
