...
<head>
	...
	<script type="text/javascript">
		var url;
                ...
                $(function(){
                 //   $('#dg').datagrid({ remoteFilter:true,url:'/app/pr_dm_juzgado/list' });       
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pr_dm_juzgado/update/'+row.IDJUZGADO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:760px;height:394px"
	    
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pr_dm_juzgado/list'"
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:402px; padding: 0 10px 0 10px;"
