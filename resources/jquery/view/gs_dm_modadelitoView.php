	...
	<script type="text/javascript">
		var url;
				...
				options:{
					panelHeight:'160',
					loader : cloader,
					url:'/app/gs_dm_delito/list',
					valueField: 'IDDELITO',  
					textField: 'NOMBRE',
					listAll : true,
					onChange:function(value){
						if (value == ''){
							 $('#dg').datagrid('removeFilterRule', 'DELITO');
						} else {
		...
		function newRecord(){
			...
			url = '/app/gs_dm_modadelito/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_dm_modadelito/update/'+row.IDMODADELITO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:840px;height:394px"
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_dm_modadelito/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="IDMODADELITO" width="10" sortable="true">C&oacute;digo</th>
				<th field="DELITO" width="40" sortable="true">Delito</th>
				<th field="NOMBRE" width="80" sortable="true">Nombre</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:312px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input name="IDMODADELITO" class="easyui-validatebox" validType="text"  required="true">
			</div>
			<div class="fitem">
				<label>Delito</label>
				<input id="ccb" class="easyui-combobox" name="IDDELITO" value="" required="true"
			    data-options="valueField: 'IDDELITO',  
                            textField: 'NOMBRE', 
                            width:280,
			    loader : cloader,
			    panelHeight:'150',
			...
			<div class="fitem">
				<label>Nombre</label>
					<textarea name="NOMBRE"  required="true"style="height: 60px;width:280px;" wrap="virtual"></textarea>
