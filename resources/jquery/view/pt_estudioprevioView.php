...
<head>
	...
	<script type="text/javascript">
		var url;
                ...
                $(function(){
                    $('#dg').datagrid('enableFilter' ,[ {
					    ...
					    options:{
						    panelHeight:'auto',
						    data:[{value:'',text:'Todos'},{value:'Terminado',  text:'Terminado' },{value:'En Estudio',  text:'En Estudio' }],
		...
		function newRecord(){
			...
			url = '/app/pt_estudioprevio/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pt_estudioprevio/update/'+row.IDPETICION;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pt_estudioprevio/list'"
