...
<head>
	...
	<script type="text/javascript">
		var url;
                ...
                $(function(){
                 //   $('#dg').datagrid({ remoteFilter:true,url:'/app/pr_dm_tipoformato/list' });       
		...
		function newRecord(){
			...
			url = '/app/pr_dm_tipoformato/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pr_dm_tipoformato/update/'+row.IDTIPO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pr_dm_tipoformato/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="CODIGO" width="30" sortable="true">C&oacute;digo </th>
				<th field="NOMBRE" width="80" sortable="true">Tipo de Formato</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:284px; padding: 0 10px 0 10px;"
