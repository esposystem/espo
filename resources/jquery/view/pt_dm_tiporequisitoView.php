...
<head>
	...
	<script type="text/javascript">
		var url;
                ...
                $(function(){
                 //   $('#dg').datagrid({ remoteFilter:true,url:'/app/pt_dm_tiporequisito/list' });       
		...
		function newRecord(){
			...
			url = '/app/pt_dm_tiporequisito/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pt_dm_tiporequisito/update/'+row.IDTIPOREQUISITO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:800px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pt_dm_tiporequisito/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="TIPOPETICION" width="150" sortable="true">Tipo de Petici&oacute;n</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:428px; padding: 0 10px 0 10px;"
			closed="true" buttons="#dlg-buttons" modal="true">
		<div class="ftitle">Datos de <?php echo $opcDesc; ?></div>
		<form id="fm" method="post" novalidate>
                        
			<div class="fitem">
				<label>Tipo de Petici&oacute;n</label>
				<input id="ccb" class="easyui-combobox" name="IDTIPOPETICION" value="" required="true"
			...
			<div class="fitem">
				<label>% Cumplimiento Pena</label>
				<input name="CUMPLIMIENTOPENA" precision="2" class="easyui-numberbox" >
			</div>
			<div class="fitem">
				<label>Pena no Superior a</label>
				<input name="ANOSMAXIMOPENA" precision="2" class="easyui-numberbox" >
			</div>
			<div class="fitem">
				<label>Edad Superior a</label>
				<input name="EDADSUPERIOR" precision="2" class="easyui-numberbox" >
			</div>
			<div class="fitem">
				<label>Estado</label>
