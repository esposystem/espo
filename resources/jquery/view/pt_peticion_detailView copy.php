...
-->
	<div id="docnew" class="easyui-dialog" title="Validaci&oacute;n del Proceso" style="width:510px;height:220px; padding: 0 10px 0 10px;"
	...
	<div id="pnldet"  style="padding: 0px;height:210px;">
	 ...
	 <div id="tt_det" class="easyui-tabs" style="width:860px;height:280px" >
	...
	<div title="Oficios" style="padding:5px;height: 240px;">
		  <a href="#" onclick="javascript:openPopWin( '/app/pr_dm_formato/vistaPrevia/' + 2,'Vista Previa',920,550,false,true);" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:120px">Vista Previa</a>
...
<!--        </div>  
	...
	<div id="dlg-buttonsValida" >
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="subirDoc()">Enviar</a>
	</div>
</body>
</html>
