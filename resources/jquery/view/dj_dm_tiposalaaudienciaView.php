...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/dj_dm_tiposalaaudiencia/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/dj_dm_tiposalaaudiencia/update/'+row.IDTIPOSALA;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/dj_dm_tiposalaaudiencia/list'"
