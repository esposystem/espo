...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/ad_dm_estapelacion/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/ad_dm_estapelacion/update/'+row.IDESTADO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/ad_dm_estapelacion/list'"
