...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/gs_dm_tipoprovicencia/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_dm_tipoprovicencia/update/'+row.IDTIPOPROVICENCIA;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:780px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_dm_tipoprovicencia/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="IDTIPOPROVICENCIA" width="20" sortable="true">C&oacute;digo</th>
				<th field="NOMBRE" width="50" sortable="true">Nombre</th>
				<th field="IDACTUACION" width="50" sortable="true">Actuaci&oacute;n que Genera</th>
				<th field="DIASREGACTUACION" width="50" sortable="true">No de D&iacute;as para  Registrar Actuaci&oacute;n</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:288px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input name="IDTIPOPROVICENCIA" class="easyui-validatebox" validType="text"  required="true">
			</div>
			<div class="fitem">
				<label>Nombre</label>
			...
			<div class="fitem">
				<label>Actuaci&oacute;n que Genera</label>
				<input name="IDACTUACION" class="easyui-validatebox" validType="text"  required="true">
			</div>
			<div class="fitem">
				<label>No de D&iacute;as para  Registrar Actuaci&oacute;n</label>
				<input name="DIASREGACTUACION" class="easyui-numberbox" required="true">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
