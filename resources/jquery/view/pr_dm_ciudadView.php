	...
	<script type="text/javascript">
		var url;
				...
				options:{
					panelHeight:'auto',
					loader : cloader,
					url:'/app/pr_dm_departamento/list',
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:740px;height:394px"
	    
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pr_dm_ciudad/list'"
	    
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="DEPARTAMENTO" width="50">Departamento</th>
				<th field="NOMBRE" width="50" sortable="true">Nombre</th>
				<th field="CODIGO" width="30" sortable="true">C&oacute;digo</th>
				<th field="ESTADO" width="30" sortable="true">Activo</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
		<a href="#" id="btn_create" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newRecord()">Crear</a>
		<a href="#" id="btn_edit" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editRecord()">Editar</a>
	</div>
	
	<div id="dlg" class="easyui-dialog" style="width:560px;height:294px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Nombre</label>
				<input name="NOMBRE" class="easyui-validatebox" validType="text" size="40" required="true">
			</div>
			<div class="fitem">
				<label>C&oacute;digo</label>
				<input name="CODIGO"  validType="text"  required="false">
			</div>
			<div class="fitem">
				<label>Activo</label>
