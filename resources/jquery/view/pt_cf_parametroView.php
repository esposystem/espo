...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/pt_cf_parametro/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/pt_cf_parametro/update/'+row.IDPARAMETRO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:780px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/pt_cf_parametro/list'"
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:298px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate> 
			<div class="fitem">
				<label>Nombre </label>
				<input name="IDPARAMETRO" class="easyui-validatebox" validType="text"  required="true">
			</div>
			<div class="fitem">
				<label>Valor </label>
				<input name="VALOR" class="easyui-validatebox" validType="text"  required="true">
			</div>
			<div class="fitem">
