...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/gs_cf_parametro/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_cf_parametro/update/'+row.IDPARAMETRO;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_cf_parametro/list'"
