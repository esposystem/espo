...
<head>
	...
	<script type="text/javascript">
		...
		function newRecord(){
			...
			url = '/app/gs_dm_claseactividad/create';
		}
		...
		function editRecord(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = '/app/gs_dm_claseactividad/update/'+row.IDCLASEACTIVIDAD;
			}
		}
		function saveRecord(){
			$('#fm').form('submit',{
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
	    ...
	    data-options="pageSize: <?php echo $config->get('GRID_NUMROWS')?>,remoteFilter:true,url:'/app/gs_dm_claseactividad/list'"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
    				<th field="IDCLASEACTIVIDAD" width="50" sortable="true">Codigo de la Clase de la Actividad</th>
				<th field="CODIGO" width="50" sortable="true">C&oacute;digo</th>
				<th field="NOMBRE" width="50" sortable="true">Nombre de la Actividad</th>
				<th field="ESTADO" width="50" sortable="true">Estado</th>
				<th field="MAXIMOHORAS" width="50" sortable="true">MAXIMOHORAS</th> </tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:264px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Codigo de la Clase de la Actividad</label>
				<input name="IDCLASEACTIVIDAD" class="easyui-numberbox" required="true">
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				<label>Estado</label>
				<input type="radio" id="ESTADO" class="easyui-validatebox" name="ESTADO" value="Activo" >Activo<input type="radio" id="ESTADO" class="easyui-validatebox" name="ESTADO" value="Inactivo" >Inactivo
			</div>
			<div class="fitem">
				<label>MAXIMOHORAS</label>
				<input name="MAXIMOHORAS" class="easyui-numberbox" required="true">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
