	...
	<script type="text/javascript">
		var url,urlInsertDisp;
				...
				options:{
					...
					onChange:function(value){
						if (value == ''){
							 $('#dg').datagrid('removeFilterRule', 'ESTABLECIMIENTO');
						} else {
		...
		function editRecord(){
			...
			if (row){
				...
				urlInsertDisp = '/app/er_saladisp/create/'+row.IDSALA;
				
			}
		
			$('#fmdisp').form('load','/app/er_saladisp/list/'+row.IDSALA);
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:700px;height:394px"
		...
		<thead>
			<tr>
    				<th field="ESTABLECIMIENTO" width="100" sortable="true">Establecimiento de Reclusi&oacute;n</th>
