...
//alert(fields[i]);
					...
					rowStrCard += '<p><div class="columna">Establecimiento  :</div><div class="columnValor">' + rowData["ESTABLECIMIENTO"] + '</div><div class="columna">Fecha de Reporte :</div><div class="columnValor">' + rowData["ANIO"] + ' / ' + rowData["MES"] + '</div></p>';
					
					rowStrCard += '<p><div class="columna">Horas Reportadas :</div><div class="columnValor">' + rowData["NUMEROHORAS"] + '</div><div class="columna">  </div><div class="columnValor"></div></p>';
					rowStrCard += '</div>';
...
<body>
	...
	<table id="dg" title="<?php echo $opcDesc; ?>" class="easyui-datagrid" style="width:820px;height:394px"
		...
		<thead>
			<tr>
    				<th field="NUMEROCERTIFICADO" width="50" sortable="true">Certifiado</th>
				<th field="IDACTIVIDAD" width="50" sortable="true">Actividad</th>
				...
				<th field="NUMEROHORAS" width="50" sortable="true">Numero de Horas</th>
				<th field="ANIO" width="50" sortable="true">A&ntilde;o Reporte</th>
				<th field="MES" width="50" sortable="true">Mes Reporte</th>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:560px;height:446px; padding: 0 10px 0 10px;"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>Numero de Horas Reportadas</label>
			...
			<div class="fitem">
				...
				<input name="FILENAME" class="easyui-validatebox" validType="text"  required="false">
			</div>
			<div class="fitem">
				<label>Tipo de Archivo</label>
				<input name="FILETYPE" class="easyui-validatebox" validType="text"  required="false">
			</div>
			<div class="fitem">
				<label>Tama&ntilde;o del Archivo</label>
				<input name="FILESIZE" class="easyui-validatebox" validType="text"  required="false">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
